...
| 🛰️ [SOAR Automation Engineer](engineering/engineering-soar-automation-engineer.md) | Playbook-as-code, alert triage automation, gated containment | Automating SOC triage and response without over-containing |
