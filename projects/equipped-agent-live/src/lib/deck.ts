    ...
    lanes: [
      ...
      },
      {
        ...
        lines: [
          ...
          "The neighborhood index, the front desk, the QR on the rider, this room — all of it came off a shelf.",
          "'Never let it say a number you can't defend' isn't advice here. It's line one of the doctrine.",
          "Val isn't for sale and it isn't a subscription — it came out of our own builds, which is why nobody else has it.",
        ],
      },
    ],
