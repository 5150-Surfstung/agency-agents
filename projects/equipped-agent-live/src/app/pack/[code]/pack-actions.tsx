...
// Copy / download for the pack. The copy button flips only on a confirmed
// clipboard write; the download builds its file client-side.

import { useState } from "react";

export function PackActions({ prompt, filename }: { prompt: string; filename: string }) {
  ...
  async function copy() {
    try {
      ...
      // Fallback: select the pre below by hand — no fake "copied".
    }
  }
